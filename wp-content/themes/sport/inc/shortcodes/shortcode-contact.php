    ...
    switch ($type) {
        ...
        if ($settings['cro_multiplerecipient'] == '2' && $count_pages->publish >= 2) {
            ...
            $op .= '</p>';
             ...
             $op .= '<input type="hidden" name="cro_formloc" id="cro_form_loc" value="0" val="0">';
        }


        $op .= '<p class="locmail">';
        $op .= '<label for="cro_form_mail">' .     __('Location:','localize') .   '</label>';
        $op .= '<input type="text" name="cro_form_locate" class="cro_validateform" contents="cro_loc" id="cro_form_locate" value="">';
        $op .= '</p>';
