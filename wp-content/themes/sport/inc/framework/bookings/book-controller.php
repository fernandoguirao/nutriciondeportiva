...
function cro_make_scheduler(){
	...
	if (!empty($bookset)) {
		...
		foreach($bookset as $crov) {
			...
			$ap .= '<div class="dateblocker selectblocker"><select name="cro_ac_select-' . $rndmzer . '" class="cro_tr">' . $ac  . '</select><select name="cro_tr_select-' . $rndmzer . '" class="cro_ar">' . $tra  . '</select>';
