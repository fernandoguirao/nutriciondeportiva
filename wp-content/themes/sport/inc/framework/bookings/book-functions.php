...
function cro_book_scripts() {
	...
	$aclist = htmlspecialchars(preg_replace("/\r?\n/", "\\n", $aclist), ENT_QUOTES);
	$tlist = htmlspecialchars(preg_replace("/\r?\n/", "\\n", $tlist), ENT_QUOTES);
	$tralist = htmlspecialchars(preg_replace("/\r?\n/", "\\n", $tralist), ENT_QUOTES);
	...
	$vals = array(
		...
		'activities'        => rtrim($aclist, ","),
		'tariffs'        	=> rtrim($tlist, ","),
		'trainers'        	=> rtrim($tralist, ",")
