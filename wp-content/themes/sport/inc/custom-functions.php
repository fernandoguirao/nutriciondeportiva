...
/**
 * Convert a time ot the time format;
 *
 * @access public
 * @return array
 */
function convert_timetoformat($time) {
	...
	$toconvert 	= $starttime + $minutes + $hours;

	$result 	= date_i18n( get_option('time_format'), $toconvert , false );
